            ...
            <div className="sticky top-20 space-y-4">
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-base">Marketplace Stats</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Total Models</span>
                    <span className="font-medium">{models?.length || 0}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Avg Return</span>
                    <span className="font-medium text-profit">
                      {models && models.length > 0 
                        ? ((models.reduce((acc, m) => acc + (m.total_return || 0), 0) / models.length) * 100).toFixed(1)
                        : 0}%
                    </span>
                  </div>
                </CardContent>
